"""
Chapter reading: https://codility.com/media/train/5-Stacks.pdf

Challenge URL: https://codility.com/demo/take-sample-test/nesting/
"""

import unittest


class TestNestedString(unittest.TestCase):
